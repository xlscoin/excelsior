...
const uint32_t UPGRADE_HEIGHT_V5                             = 4; // Upgrade height for CN-SoftShell Variant 2 switch.
const uint32_t UPGRADE_HEIGHT_V6                             = 10800; // Upgrade height for CN-Turtle Variant 2 switch.
